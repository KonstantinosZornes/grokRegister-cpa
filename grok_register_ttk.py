...
def prepare_browser_proxy(use_proxy=True, log_callback=None):
    ...
    if _proxy_has_auth(proxy):
        ...
        if log_callback:
            log_callback("[!] Chromium 暂不直接支持该认证代理协议，已使用去认证代理地址（无认证）")
...
def build_profile():
    given_name_pool = [
        "Aaron", "Adam", "Aiden", "Alan", "Albert", "Alex", "Alexis", "Alfie",
        "Alvin", "Amani", "Amir", "Anderson", "Andre", "Andrew", "Angelo", "Anthony",
        "Antonio", "Aron", "Arthur", "Asher", "Ashton", "Atlas", "Auden", "August",
        "Austin", "Avery", "Axel", "Bryan", "Caleb", "Callum", "Camden", "Cameron",
        "Carl", "Carter", "Cedric", "Chad", "Charles", "Chase", "Chester", "Chris",
        "Christian", "Christopher", "Clark", "Clayton", "Cody", "Colin", "Collin", "Conor",
        "Connor", "Cooper", "Cory", "Cristian", "Curtis", "Cyrus", "Damian", "Damon",
        "Daniel", "Danny", "Darian", "Darren", "David", "Dawson", "Dean", "Declan",
        "Demetri", "Dennis", "Derek", "Derick", "Derrick", "Devin", "Dexter", "Diego",
        "Dilan", "Dillon", "Dimitri", "Dominic", "Dominick", "Donald", "Douglas", "Drake",
        "Drew", "Duncan", "Dustin", "Dylan", "Eddie", "Eli", "Elias", "Elio",
        "Eliot", "Elliot", "Ellis", "Emerson", "Emil", "Emilio", "Emmanuel", "Eric",
        "Erik", "Esteban", "Ethan", "Eugene", "Evan", "Everett", "Ezra", "Fabian",
        "Felix", "Fernando", "Finn", "Finnegan", "Fletcher", "Flynn", "Francis", "Frank",
        "Frankie", "Frasier", "Freddie", "Freddy", "Gabriel", "Gael", "Gage", "Garrett",
        "Gary", "Gavin", "George", "Gerald", "Gilberto", "Glen", "Gordon", "Grady",
        "Graham", "Grant", "Grayson", "Gregory", "Gunner", "Gus", "Harlan",
        "Harper", "Harrison", "Harry", "Harvey", "Hassan", "Hayden", "Heath", "Hector",
        "Henry", "Herbert", "Holden", "Hudson", "Hugh", "Hunter", "Hyrum", "Ian",
        "Ibrahim", "Idris", "Iker", "Ivan", "Ivor", "Jack", "Jackson", "Jacob",
        "Jaden", "Jagger", "Jaiden", "James", "Jameson", "Jamie", "Jared", "Jarius",
        "Jarrod", "Jason", "Jasper", "Javier", "Jay", "Jayce", "Jayden", "Jaylen",
        "Jeff", "Jeffrey", "Jensen", "Jeremy", "Jerome", "Jerry", "Jesse", "Jett",
        "Jevan", "Jim", "Jimmy", "Joachim", "Joel", "John", "Johnathan",
        "Jolion", "Jon", "Jonah", "Jonas", "Jonathan", "Jordan", "Jordy", "Jorge",
        "Jose", "Joseph", "Joshua", "Josiah", "Jovan", "Jude", "Julian", "Julien",
        "Julius", "Junior", "Kabir", "Kai", "Kaiden", "Kale", "Kaleb", "Kalin",
        "Kameron", "Kamran", "Kane", "Karim", "Karl", "Karson", "Kasey", "Kayden",
        "Keith", "Kellan", "Kellen", "Kelly", "Kelvin", "Ken", "Kennedy", "Kenneth",
        "Kenny", "Kent", "Kenton", "Kerem", "Kern", "Khalid", "Kian", "Kieran",
        "Kim", "Kingston", "Kiran", "Klaus", "Kobe", "Koby", "Kolton", "Konstantin",
        "Korbin", "Kody", "Krish", "Kristian", "Kurt", "Kyle", "Lachlan", "Lance",
        "Landen", "Lane", "Langston", "Larry", "Lauren", "Lautaro", "Lawrence", "Lawson",
        "Lee", "Leland", "Lemuel", "Len", "Leo", "Leon", "Leonard", "Leonardo",
        "Leroy", "Levi", "Levin", "Levy", "Liam", "Lincoln", "Linus", "Logan",
        "London", "Lonnie", "Lorenzo", "Louis", "Luca", "Lucas", "Lucian", "Lucius",
        "Luis", "Luka", "Lukas", "Luke", "Lyric", "Magnus", "Maison", "Malachi",
        "Malcolm", "Manuel", "Marcus", "Mario", "Mark", "Marlon", "Marshall", "Martin",
        "Marvin", "Mason", "Mateo", "Mathias", "Matthew", "Maury", "Maverick", "Max",
        "Maxim", "Maximilian", "Maxwell", "Mehmet", "Melvin", "Micah", "Michael", "Miguel",
        "Miles", "Milovan", "Misha", "Mischa", "Mitchell", "Mohamed", "Mohammed", "Mohammad",
        "Moses", "Murphy", "Murray", "Musa", "Myles", "Nash", "Nasser", "Nathan",
        "Nathanael", "Nathaniel", "Neal", "Neil", "Nelson", "Neo", "Neville", "Nicholas",
        "Nick", "Nickolas", "Nico", "Nicolas", "Nigel", "Niklas", "Niko", "Nikolai",
        "Nikolas", "Noah", "Noe", "Nolan", "Norman", "Oakley", "Odin", "Oliver",
        "Omar", "Orion", "Orlando", "Oscar", "Oswald", "Otis", "Otto", "Owen",
        "Pablo", "Paris", "Parker", "Patrick", "Paul", "Paxton", "Pedro", "Percival",
        "Perry", "Pete", "Peter", "Phillip", "Pierce", "Pierre", "Presley", "Preston",
        "Princeton", "Quentin", "Quincy", "Quinn", "Rafael", "Ralph", "Ramon", "Randal",
        "Randall", "Randolf", "Randy", "Rashawn", "Rasmus", "Raul", "Ray", "Raymond",
        "Reagan", "Reece", "Reid", "Reilly", "Reinhold", "Remington", "Rene", "Reuben",
        "Rex", "Rhett", "Rhys", "Ricardo", "Richard", "Rick", "Ricky", "Ridge",
        "Robbie", "Robert", "Robin", "Rocco", "Rockwell", "Rodney", "Rodrigo", "Rogan",
        "Roger", "Rohan", "Roland", "Roman", "Ronan", "Ronnie", "Rory", "Ross",
        "Rowan", "Roy", "Royce", "Ruben", "Rudy", "Rupert", "Ryan", "Ryker",
        "Ryland", "Sage", "Sahil", "Salvador", "Sam", "Samer", "Samson", "Samuel",
        "Sander", "Sanders", "Sandro", "Santiago", "Santino", "Saul", "Sawyer", "Scott",
        "Scottie", "Sean", "Sebastian", "Sergio", "Seth", "Shane", "Shawn", "Shea",
        "Sheldon", "Sherman", "Shiloh", "Sidney", "Silas", "Simon", "Sincere", "Skeet",
        "Solomon", "Sonny", "Spencer", "Stanley", "Stefan", "Stephan", "Stephen", "Sterling",
        "Steve", "Steven", "Stuart", "Sutton", "Sven", "Sylvester", "Tadeo", "Tadashi",
        "Tai", "Taj", "Talon", "Tariq", "Tate", "Tatian", "Taylor",
        "Ted", "Teddy", "Tennyson", "Terence", "Terrance", "Terrell", "Terry", "Tevin",
        "Thaddeus", "Theo", "Theodore", "Theron", "Thomas", "Thorn", "Tim", "Timmy",
        "Timothy", "Titus", "Tobias", "Toby", "Tod", "Tom", "Tommy", "Tony",
        "Travis", "Trent", "Trenton", "Trevor", "Tristan", "Troy", "Tucker", "Tyler",
        "Tyree", "Tyrell", "Tyson", "Umar", "Ulrich", "Ulysses", "Ursula",
        "Vance", "Vaughn", "Veer", "Viktor", "Vince", "Vincent", "Vinnie", "Virgil",
        "Vito", "Vivaan", "Vladimir", "Wade", "Walker", "Wallace", "Walter", "Ward",
        "Warren", "Waylon", "Wayne", "Wells", "Wendel", "Wesley", "Weston", "Wilbur",
        "Will", "William", "Willis", "Willy", "Wilson", "Windsor", "Winston", "Wyatt",
        "Wystan", "Xander", "Xavier", "Xzavier", "Yadiel", "Yahir", "Yaqub", "Yasin",
        "Yehuda", "Yousef", "Yousuf", "Yuri", "Yusuf", "Zachariah", "Zachary",
        "Zack", "Zackary", "Zain", "Zander", "Zane", "Zayd", "Zayne", "Zeke",
        "Zen", "Ziggy", "Zion", "Zoltan", "Zorion", "Zyon",
        "Aldo", "Bodhi", "Caspian", "Dario", "Emmett", "Enzo", "Florian", "Hugo",
        "Joaquin", "Leon", "Matteo", "Niko", "Otto", "Rocco", "Salvatore", "Theo",
        "Valentino", "Wade", "Yusuf", "Zane", "Bruno", "Dante", "Eli", "Felix",
        "Gino", "Hugo", "Luca", "Marco", "Nico", "Omar", "Paolo", "Rocco",
        "Sergio", "Tomas", "Ugo", "Vito", "Walter", "Xavi", "Yago", "Zeno",
        "Akira", "Daichi", "Haru", "Kenji", "Riku", "Sora", "Takeshi", "Yuki",
        "Arjun", "Dev", "Kabir", "Rohan", "Vivaan", "Aryan", "Ishaan", "Reyansh",
        "Kwame", "Malik", "Sekou", "Tariq", "Zaire", "Bilal", "Diallo", "Mansa",
        "Chen", "Jian", "Min", "Wei", "Xin", "Bo", "Feng", "Hao",
        "Dakota", "Helena", "Indira", "Jasper", "Kiana", "Lorenzo", "Mateo",
        "Nash", "Omari", "Pablo", "Rashid", "Samir", "Tariq", "Ulysses", "Vincenzo",
        "Wolfgang", "Xylon", "Yael", "Zev",
    ]
    family_name_pool = [
        ...
        "Wei", "Xiong",
        "Abel", "Adair", "Adams", "Alexander", "Allen", "Anderson", "Andrews", "Arnold",
        "Austin", "Bailey", "Baker", "Baldwin", "Banks", "Barber", "Barnes", "Barrett",
        "Bass", "Bell", "Bennett", "Berry", "Bishop", "Black", "Blake", "Blanchard",
        "Bolton", "Bond", "Booth", "Boyd", "Brady", "Brand", "Brennan", "Brooks",
        "Brown", "Bruce", "Bryant", "Buck", "Burke", "Burns", "Butler", "Byrne",
        "Cameron", "Campbell", "Carroll", "Carson", "Carter", "Chambers", "Chandler", "Chapman",
        "Christensen", "Clark", "Clarke", "Clayton", "Cohen", "Cole", "Coleman", "Collins",
        "Conner", "Cook", "Cooper", "Cox", "Craig", "Crawford", "Cross", "Curtis",
        "Daley", "Daniel", "Daniels", "Davidson", "Davies", "Davis", "Dawson", "Dean",
        "Delgado", "Diaz", "Dixon", "Douglas", "Drake", "Dunbar", "Duncan", "Dunn",
        "Edwards", "Elliott", "Ellis", "English", "Ernst", "Escobar", "Espinoza", "Evans",
        "Farmer", "Ferguson", "Fernandez", "Ferrer", "Fischer", "Fisher", "Fitzgerald", "Flores",
        "Ford", "Foster", "Fowler", "Francis", "Franklin", "Frazier", "Freeman", "Frost",
        "Gallagher", "Garcia", "Gardner", "Garner", "Garrett", "Gibson", "Gilbert", "Gill",
        "Glover", "Gomez", "Gonzalez", "Gordon", "Grant", "Graves", "Gray", "Green",
        "Greene", "Gregory", "Griffin", "Griffith", "Gross", "Gupta", "Gutierrez", "Guzman",
        "Hall", "Hamilton", "Hansen", "Hardy", "Harper", "Harris", "Harrison", "Hart",
        "Hartman", "Harvey", "Hawkins", "Hayes", "Haynes", "Henderson", "Henry", "Hernandez",
        "Herrera", "Herrmann", "Hicks", "Hill", "Hoffman", "Holland", "Hopkins", "Howard",
        "Hudson", "Hughes", "Hunt", "Hunter", "Hurst", "Jackson", "Jacobs", "James",
        "Jefferson", "Jenkins", "Jennings", "Jensen", "Jimenez", "Johnson", "Johnston", "Jones",
        "Jordan", "Joyce", "Juarez", "Kaufman", "Keller", "Kelley", "Kelly", "Kennedy",
        "Kent", "Kerr", "Khan", "Kim", "King", "Kirby", "Kirk", "Klein",
        "Knox", "Kramer", "Kumar", "Lambert", "Lane", "Larson", "Lawrence", "Lawson",
        "Leach", "Lee", "Leon", "Leonard", "Lewis", "Lincoln", "Little", "Lloyd",
        "Logan", "Long", "Lopez", "Lowe", "Lucas", "Lynch", "MacDonald", "Magee",
        "Mahoney", "Malone", "Manning", "Marshall", "Martin", "Martinez", "Mason", "Matthews",
        "Maxwell", "May", "McCarthy", "McDonald", "McKenzie", "McLaughlin", "Mendez", "Mendoza",
        "Meyer", "Meyers", "Miller", "Mills", "Mitchell", "Monroe", "Montgomery", "Moore",
        "Moran", "Morgan", "Morris", "Morrison", "Murray", "Murphy", "Myers", "Nash",
        "Nelson", "Newman", "Newton", "Nguyen", "Nichols", "Nixon", "Norman", "Norton",
        "O'Brien", "O'Connor", "O'Neill", "Owens", "Page", "Palmer", "Parker",
        "Parks", "Parsons", "Pate", "Patel", "Patton", "Paul", "Payne", "Pearson",
        "Pena", "Perez", "Perkins", "Perry", "Peters", "Petersen", "Peterson", "Phillips",
        "Pierce", "Pittman", "Pope", "Porter", "Powell", "Powers", "Preston", "Price",
        "Prince", "Pruitt", "Quinn", "Ramirez", "Ramos", "Randall", "Rasmussen", "Ray",
        "Reed", "Reyes", "Reynolds", "Rhodes", "Rice", "Rich", "Richards", "Richardson",
        "Riggs", "Riley", "Rivera", "Robbins", "Roberts", "Robertson", "Robinson", "Rodgers",
        "Rodriguez", "Rogers", "Romero", "Rosa", "Rosario", "Rose", "Ross", "Rowe",
        "Rowland", "Roy", "Ruiz", "Russell", "Ryan", "Salazar", "Sanchez", "Sanders",
        "Sandoval", "Santiago", "Santos", "Schaefer", "Schmidt", "Schneider", "Schroeder",
        "Schultz", "Schwartz", "Scott", "Sellers", "Serrano", "Shaw", "Shelton", "Sherman",
        "Silva", "Simmons", "Simon", "Simpson", "Sims", "Singleton", "Skinner", "Smith",
        "Snyder", "Soto", "Sparks", "Spears", "Stanley", "Stanton", "Stark", "Steele",
        "Stephens", "Stevens", "Stewart", "Stokes", "Stone", "Stout", "Stuart", "Suarez",
        "Sullivan", "Summers", "Sutton", "Swanson", "Sweeney", "Tate", "Taylor", "Terrell",
        "Thomas", "Thompson", "Thornton", "Tillman", "Todd", "Torres", "Tran", "Travis",
        "Trevino", "Tucker", "Turner", "Underwood", "Vargas", "Vasquez", "Vaughn", "Vega",
        "Velasquez", "Villarreal", "Vincent", "Wagner", "Walker", "Wallace", "Waller", "Walls",
        "Walsh", "Walters", "Walton", "Ward", "Warner", "Warren", "Washington", "Waters",
        "Watkins", "Watson", "Watts", "Webb", "Weber", "Welch", "Wells", "West",
        "Wheeler", "Whitaker", "White", "Whitfield", "Whitley", "Wilcox", "Wiley", "Wilkerson",
        "Wilkins", "Wilkinson", "Williams", "Willis", "Wilson", "Winston", "Wise", "Wolf",
        "Wolfe", "Wood", "Woods", "Wright", "Wyatt", "Yates", "Yoder",
        "Young", "Zamora",
        "Ackerman", "Alvarez", "Ambrose", "Applegate", "Archer", "Babcock", "Beauchamp",
        "Bench", "Bishara", "Bouchard", "Boucher", "Bourbon", "Calderon", "Carey",
        "Caruso", "Castellano", "Cervantes", "Chamberlain", "Cheng", "Chiu", "Chow",
        "Clifford", "Cobb", "Costa", "Cote", "Coughlin", "Crane", "Curran", "Dahl",
        "Dalton", "Davenport", "Deacon", "Delgado", "Dorsey", "Doucette", "Doyle",
        "Driscoll", "Dunne", "Eastman", "Eaton", "Eichhorn", "English", "Estes",
        "Fairbanks", "Faulkner", "Fenton", "Finley", "Foley", "Fontaine", "Forbes",
        "Fortin", "Fournier", "Frost", "Gall", "Garnett", "Gaudet", "Gauthier",
        "Gere", "Gershon", "Goldberg", "Goldman", "Goodwin", "Graves", "Greene",
        "Gresham", "Haddad", "Hahn", "Hammond", "Harrington", "Hatcher", "Hawthorne",
        "Haywood", "Hebert", "Hendricks", "Hennessey", "Hennesy", "Hightower", "Hitchcock",
        "Hobbs", "Holland", "Hoover", "Howell", "Hsu", "Hubbard", "Huffman",
        "Hutchinson", "Ibarra", "Iverson", "Jacoby", "Jardine", "Jarrett", "Jennings",
        "Johansson", "Kane", "Kantor", "Kapoor", "Kearney", "Kelsey", "Kendall",
        "Kerr", "Key", "Khan", "Killebrew", "Kirkland", "Kirkpatrick", "Kitteredge",
        "Klein", "Knapp", "Knowles", "Koenig", "Kowalski", "Krause", "Krieger",
        "Krueger", "Lacy", "Lai", "Lamb", "Lam", "Larsson", "Latham",
        "Latimer", "Lau", "Lavin", "Lawson", "Leblanc", "Lehmann", "Lemieux",
        "Leong", "Lester", "Liang", "Lim", "Lin", "Lindqvist", "Locke",
        "Lombardi", "Loomis", "Lord", "Lovett", "Lowery", "Luo", "Lutz",
        "Ma", "Macias", "Mackenzie", "Mahmoud", "Mak", "Malik", "Manfra",
        "Marchetti", "Marks", "Marlow", "Marsh", "Mather", "Matlock", "Mauro",
        "Maxwell", "Mays", "McAllister", "McBride", "McCall", "McClain", "McFarland",
        "McGee", "McIntyre", "McKay", "McMillan", "McNeil", "Mehta", "Mendoza",
        "Meredith", "Messina", "Metz", "Meyer", "Michaels", "Mifflin", "Miranda",
        "Mo", "Modine", "Mohr", "Moll", "Monaghan", "Montague", "Mooney",
        "Morrow", "Mosley", "Mueller", "Muldoon", "Mullen", "Munger", "Munoz",
        "Nair", "Nakamura", "Nance", "Nash", "Neel", "Nevins", "Ng",
        "Nielsen", "Nieves", "Nixon", "Nolan", "Noonan", "Norris", "Norrington",
        "Nunn", "Oakes", "O'Connell", "O'Donnell", "Ogden", "Oliphant", "Olmstead",
        "Olson", "O'Neal", "O'Rourke", "Ormsby", "Orr", "Ortiz", "Ortmann",
        "Overton", "Owens", "Ozawa", "Pace", "Packard", "Padilla", "Pagan",
        "Palmieri", "Parise", "Park", "Parrish", "Patel", "Patrick", "Pemberton",
        "Pereira", "Perkins", "Perrin", "Pessoa", "Pham", "Phelps", "Pickens",
        "Pickett", "Pinckney", "Pineda", "Pollard", "Polo", "Ponce", "Pond",
        "Pool", "Porter", "Posey", "Pratt", "Prater", "Presley", "Pryor",
        "Pucci", "Pugliese", "Qualls", "Quigley", "Quinlan", "Quinn", "Race",
        "Radcliffe", "Raines", "Raleigh", "Ramsay", "Ranch", "Rasco", "Rawlins",
        "Raymond", "Reardon", "Reeves", "Reichert", "Renner", "Reuter", "Rhoades",
        "Riggs", "Riordan", "Rist", "Roach", "Robideaux", "Robins", "Robinson",
        "Rosa", "Rossi", "Rounds", "Rousseau", "Rowan", "Roy", "Rubin",
        "Rule", "Runyon", "Russo", "Sabatini", "Salas", "Salerno", "Sallee",
        "Sang", "Sapp", "Sartori", "Sasser", "Saunders", "Savidge", "Sayre",
        "Scanlon", "Schilling", "Schoenberg", "Schraeder", "Schroder", "Schunk",
        "Scoles", "Seaborn", "Seger", "Sellers", "Semler", "Sena", "Serafin",
        "Serra", "Shackelford", "Shapiro", "Shea", "Shepard", "Sherlock", "Shinn",
        "Shores", "Shreve", "Siegel", "Sierra", "Silver", "Sime", "Simons",
        "Skelton", "Slater", "Sloane", "Small", "Smart", "Smiley", "Snell",
        "Snyder", "Sokol", "Solano", "Sommer", "Sorensen", "Sorrentino", "Spake",
        "Speer", "Spence", "Spencer", "Springer", "Sproul", "Stanfill", "Stanton",
        "Stark", "Staton", "Steadman", "Stein", "Stephens", "Stetson", "Stevens",
        "Stiller", "Stimson", "Stockton", "Stokes", "Stone", "Stoney", "Stout",
        "Strader", "Strand", "Strickland", "Strong", "Stull", "Su", "Sullivan",
        "Summers", "Sutherland", "Sutton", "Sweeney", "Swenson", "Swift", "Swiger",
        "Taggart", "Takahashi", "Tan", "Tang", "Tate", "Taylor", "Teague",
        "Teller", "Templeton", "Thacker", "Thayer", "Thibodeaux", "Thielen", "Thomason",
        "Thomas", "Thompson", "Thomson", "Thornton", "Thurston", "Tierney", "Tilley",
        "Tobias", "Todd", "Toland", "Toledo", "Tomlinson", "Toporek", "Torres",
        "Tovar", "Tran", "Travers", "Travis", "Trevino", "Trimble", "Trinh",
        "Troutman", "Tsai", "Tu", "Tucker", "Turner", "Upton", "Urena",
        "Valadez", "Valdez", "Valentine", "Vance", "Van", "Vander", "Vann",
        "Vargas", "Vaughn", "Vega", "Velasquez", "Ventura", "Vick", "Vickers",
        "Vigil", "Villarreal", "Vincent", "Vinson", "Vlad", "Voss", "Wagner",
        "Wagoner", "Walden", "Walker", "Wall", "Waller", "Walsh", "Walton",
        "Wang", "Warner", "Warren", "Waters", "Watkins", "Watson", "Watts",
        "Weaver", "Webb", "Weber", "Welch", "Wells", "Wen", "Wendt",
        "Wessell", "West", "Westbrook", "Weston", "Whalen", "Wheeler", "Whitfield",
        "Whitley", "Whitman", "Whitney", "Wicks", "Wiest", "Wilcox", "Wiley",
        "Wilkerson", "Wilkins", "Wilkinson", "Willard", "Williams", "Willis", "Willoughby",
        "Wilson", "Wilton", "Wimmer", "Winfrey", "Winston", "Winter", "Wirth",
        "Wisdom", "Wise", "Witt", "Wolf", "Wolfe", "Wolff", "Wong",
        "Wood", "Woodard", "Woods", "Woodward", "Wootten", "Worth", "Wright",
        "Wu", "Wyatt", "Wyche", "Wynn", "Yamamoto", "Yamamoto", "Yang",
        "Yates", "Yeager", "Yi", "Yoder", "Yokoyama", "York", "Yost",
        "Young", "Yu", "Zambrano", "Zamora", "Zhang", "Zheng", "Zhou",
        "Zimmerman", "Zook",
    ]
